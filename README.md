...
For a tutorial see [this example](https://github.com/ruboerner/GravMag3D/blob/main/example_01.md), which has been processed from the original MATLAB Live Script using this [Live Script to MATLAB Converter](https://github.com/roslovets/Live-Script-to-Markdown-Converter).
